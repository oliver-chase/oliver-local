...
1. `<vault-root>/Oliver/_Project Repos/oliver-local/contracts/PROJECT_HYGIENE_STANDARD.md`
2. `<vault-root>/Oliver/_Project Repos/oliver-local/contracts/PROJECT_STRUCTURE_STANDARD.md`
...
4. Source-of-truth link: `<vault-root>/Oliver/_Project Repos/oliver-local/shared/workflow-standards.md`.
