...
1. `<vault-root>/_Management/Agent Orchestration/repos/oliver-local/contracts/PROJECT_HYGIENE_STANDARD.md`
2. `<vault-root>/_Management/Agent Orchestration/repos/oliver-local/contracts/PROJECT_STRUCTURE_STANDARD.md`
...
4. Source-of-truth link: `<vault-root>/_Management/Agent Orchestration/repos/oliver-local/shared/workflow-standards.md`.
