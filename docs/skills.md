...
`<vault-root>/Oliver/_Project Repos/oliver-local/skills` is the canonical shared skill layer for this system. Runtime adapters reference these shared skills.
