...
- Local path: `~/projects/oliver-app-main`
- Git remote: `git@github.com:oliver-chase/oliver-app.git`
- Branch intent: `promote-main-epics` worktree for mainline promotion packaging
- Primary docs: `~/projects/oliver-app-main/CLAUDE.md`, `~/projects/oliver-app-main/README.md`, `~/projects/oliver-app-main/AGENTS.md`
