...
```bash
<vault-root>/Oliver/_Project Repos/oliver-local/scripts/run-governance-gates.sh <vault-root>/Oliver/_Project Repos/<repo>
```
...
```bash
<vault-root>/Oliver/_Project Repos/oliver-local/scripts/run-nightly-governance.sh
```

Status report output:
- `<vault-root>/Oliver/_Project Repos/oliver-local/docs/runtime-verification/governance-status.md`
...
- Runtime adapters may point to `<vault-root>/Oliver/_Project Repos/oliver-local/skills`, but project repos must not.
...
```bash
<vault-root>/Oliver/_Project Repos/oliver-local/scripts/install-governance-hook.sh
```

Each repo hook executes repo-scoped governance gates before commit.

- Oliver-local repo operations: `<vault-root>/Oliver/_Project Repos/oliver-local/docs/oliver-local-repo-operations.md`
