...
Canonical shared orchestration files live in `<vault-root>/_Management/Agent Orchestration/workspace/repos/orchestration/oliver-local`. Do not treat `~/.codex` as the shared-system source of truth.
...
- Shared skills belong in `<vault-root>/_Management/Agent Orchestration/workspace/repos/orchestration/oliver-local/skills`; runtime-local skill links may point there.
- `~/.codex/skills/story-lifecycle-gate` points to `<vault-root>/_Management/Agent Orchestration/workspace/repos/orchestration/oliver-local/skills/story-lifecycle-gate`.
