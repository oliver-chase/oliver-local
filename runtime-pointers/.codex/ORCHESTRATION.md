...
- Shared system docs: `<vault-root>/Oliver/_Project Repos/oliver-local/docs`
...
Codex runtime files stay in `~/.codex`. Canonical shared orchestration assets live in `<vault-root>/Oliver/_Project Repos/oliver-local`.
