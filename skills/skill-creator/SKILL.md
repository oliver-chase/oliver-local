...
- "Where should I create this skill? If you do not have a preference, I will place it in `~/oliver-local/skills` so shared runtime adapters can discover it consistently."
...
Before running `init_skill.py`, ask where the user wants the skill created. If they do not specify a location, default to `~/oliver-local/skills` so shared runtime adapters can discover it consistently.
