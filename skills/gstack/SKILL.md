...
5. Tell the user: "Done. Each developer now runs: `cd <vault-root>/_Management/Agent Orchestration/workspace/repos/orchestration/oliver-local/skills/gstack && ./setup --team`"
